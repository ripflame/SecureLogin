	...
	<body>
		...
		<div class="ContenedorPrincipal">
			...
			<div class="ContenedorContenido">
				<form action="Admin/guardarCambiosDeUsuario.php" method="post">
					...
					<p>
						Usuario: <input type="text" name="username" value=<?php echo obtenerUsuario()->getUserName(); ?> >
						<input type="hidden" name="usernameOriginal" value=<?php echo obtenerUsuario()->getUserName(); ?> >
					</p>
					<p>Apellido Paterno: <?php echo obtenerUsuario()->getApellido1(); ?></p>
					<p>Apellido Materno: <?php echo obtenerUsuario()->getApellido2(); ?></p>
					<p>Nombre: <?php echo obtenerUsuario()->getNombres(); ?></p>
					<p>
						Correo: <input type="text" name="correo" value=<?php echo obtenerUsuario()->getEmail(); ?> >
					</p>
